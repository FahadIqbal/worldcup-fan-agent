...
export const TEAMS: Record<string, TeamInfo> = {
  ...
  PER: { name: "Peru",         code: "PER", flag: "🇵🇪", elo: 1625, fifaRank: 40, confederation: "CONMEBOL" },
  JAM: { name: "Jamaica",      code: "JAM", flag: "🇯🇲", elo: 1619, fifaRank: 41, confederation: "CONCACAF" },
  HON: { name: "Honduras",     code: "HON", flag: "🇭🇳", elo: 1608, fifaRank: 42, confederation: "CONCACAF" },
